...
class RunoffObservationConstraintForPlotsOnly(ObservationConstraint):
    ...
    def __init__(self, watershed_name: str, final_year: Union[None, int] = None):
        ...
        years, constraint_name_to_values = load_csv_with_constraint(2, 'Q', filepath)
...
if __name__ == '__main__':
    print(RunoffObservationConstraintForPlotsOnly('Dargol_Kakassi'))
